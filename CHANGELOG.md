...
- [Documentation] Add a conventions reference at docs/conventions.md
- [Documentation] Add Ling 3.0 tuning notes
- [Documentation] Add MiniCPM5 tuning notes
...
- [Documentation] Move the no-host, fit, swa-full and context-shift mechanisms into docs/presets.md
...
- [Documentation] Correct the flash-attention fallback from a CPU-backend collapse to an f16 K/V conversion above b10876
